...
% copied from infTRN_lassoStARS-master/glmnet/glmnetSet.m by Dr. Emily Miraldi. The change is the options.cl value (line 158) from [-Inf;Inf] to [0;Inf] to limit solve to be positive only.
%-------------------------------------------------------------------------- 
