function estimateInstabilitiesTRNbStARS_noTfaNomRNA(geneExprMat,tfaMat,lambdaBias,tfaOpt,...
...
% modified on 2021.5.29. for no tfa mode (tfaOpt=''), predictorMat will only contain tfa estimated by equation, not contain tfmRNA. (without my change, predictorMat will contain tfa estimated by equation and also mRNA for those TFs without prior but with mRNA levels)
...
%!!! modified !!!
allPredictors = cellstr(strvcat(pRegs));
if tfaOpt
...
%predictorMat = [medTfas; potRegMat_mRNA(uniNoPriorRegInds,:)]; this line is removed, the next line is added!!!
predictorMat = medTfas; 
